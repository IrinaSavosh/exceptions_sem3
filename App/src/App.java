...
// быть корректно обработано, пользователю выведено сообщение с информацией, что именно
// неверно.
...
public class App {
    public static void main(String[] args) throws IOException {
        ...
        UserInformationTwo user = new UserInformationTwo();


        SaveToFile save = new SaveToFile(user.getUserData());
